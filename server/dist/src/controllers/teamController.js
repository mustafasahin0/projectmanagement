...
const getTeams = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const teamWithUsernames = yield Promise.all(teams.map((team) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        res.status(500).json({
            message: `Error occured while retrievening teams: ${error.message}`,
        });
    }
});
